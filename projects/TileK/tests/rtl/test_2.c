...
int main() {
  ...
  kernel->data[1].mode = e_klt_read_write;
  kernel->data[1].liveness = e_klt_live_inout;
  ...
  kernel->data[2].mode = e_klt_read_write;
  kernel->data[2].liveness = e_klt_live_inout;
  ...
  kernel->data[3].liveness = e_klt_live_inout;
  ...
  kernel->data[4].liveness = e_klt_live_inout;
